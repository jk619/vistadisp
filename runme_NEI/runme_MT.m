...
params.doEyelink            = 1;
params.savefilepath         = '/Users/winawerlab/matlab/toolboxes/vistadisp/data_NEI/mot'; %if not specified it will save files in vistarootpath dir
...
initials = 'XX'; % specify subjects initials
